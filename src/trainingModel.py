...
class trainModel:
    ...
    def __init__(self):
        ...
        self.file_object = open(config["data_preparation"]["training_log"]+"/ModelTrainingLog.txt", 'a+')
    ...
    def trainingModel(self):
        ...
        try:
            ...
            X,Y=preprocessor.separate_label_feature(data,label_column_name=config["base"]["target_col"])
