    ...
    def is_null_present(self,data):
        ...
        try:
            ...
            if(self.null_present): # write the logs to see which columns have null values
                ...
                dataframe_with_null.to_csv(config["data_preprocessing"]["preprocessed_data_dir"] + "/" + config["data_preprocessing"]["null_values_csv"]) # storing the null column information to file
